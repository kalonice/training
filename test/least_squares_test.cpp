...
TEST(Smoke_test, manually_precalculated_examples___ax_b) {
    // f = a*x + b
...
TEST(Smoke_test, manually_precalculated_examples___asinx_b_cx) {
    // f = a*sin(x) + b + c*x
...
TEST(Smoke_test, manually_precalculated_examples___ax_bxx_cxxx) {
    // f = a*x + b*x^2 + c*x^3
    std::vector<std::vector<double>> parameters_matrix = {
            {1, 2, 3, 4, 5, 6},
